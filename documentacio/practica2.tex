...
Per aquesta prova demanarem una recomanació de viatge de final de curs a l'\emph{SBC}.\\
...
\subsection{Un viatge per un milionari}
Per aquesta prova demanarem una recomanació de viatge a l'\emph{SBC} per una persona de classe social molt alta i amb molts diners.\\

\noindent
\begin{tabular}{|p{0.28\textwidth}|p{0.73\textwidth}|}
\hline
\textbf{\mbox{Condicions de la} \mbox{prova}} & \\
\hline
\textbf{Comportament \mbox{esperat de l'\emph{SBC}}} & Estimem que l'SBC donarà un viatge vàlid dins les restriccions demanades. Tenint en compte el pressupost esperem que s'escullin activitats i hotels de baix pressupost. \\
\hline
\textbf{\mbox{Resultats de la} \mbox{prova}} & \\
